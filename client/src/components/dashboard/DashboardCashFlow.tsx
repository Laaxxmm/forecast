              ...
              if (view === 'overall') {
                ...
                return (
                  <tr key={row.key} className={`border-b border-dark-400/30 ${row.isTotal ? 'font-semibold bg-dark-600/50' : ''}`}>
                    <td className={`py-2.5 px-4 sticky left-0 z-10 ${row.isTotal ? 'bg-dark-600/50' : 'bg-dark-700'} ${row.indent ? 'pl-10' : ''}`}>{row.label}</td>
                ...
                return (
                  <tr key={row.key} className={`border-b border-dark-400/30 ${row.isTotal ? 'font-semibold bg-dark-600/50' : ''}`}>
                    <td className={`py-2 px-4 sticky left-0 z-10 ${row.isTotal ? 'bg-dark-600/50' : 'bg-dark-700'} ${row.indent ? 'pl-10' : ''}`}>{row.label}</td>
                    {periodMonths.map(m => {
