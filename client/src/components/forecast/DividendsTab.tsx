...
import {
  Plus, FileDown, GripVertical, MoreVertical, HelpCircle
} from 'lucide-react';
          ...
          >
            <button
              onClick={() => {
                ...
                if (item) { setEditingItem(item); setMenuOpenId(null); }
              }}
              className="w-full text-left px-3 py-2 text-sm hover:bg-dark-600 rounded-t-lg"
            >Edit</button>
            <button
              onClick={() => {
                const item = items.find(i => i.id === menuOpenId);
              ...
              className="w-full text-left px-3 py-2 text-sm hover:bg-dark-600"
            >Duplicate</button>
            <button
              onClick={() => { if (menuOpenId) handleDelete(menuOpenId); }}
              className="w-full text-left px-3 py-2 text-sm text-red-400 hover:bg-red-500/10 rounded-b-lg"
            >Delete</button>
          </div>
        </>
      )}
