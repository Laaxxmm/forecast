    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="/vcfo/cost-allocation" element={<ClientRoute><ClientAdminRoute><ModuleRoute moduleKey="vcfo_portal"><VcfoRoleRoute><CostAllocationPage /></VcfoRoleRoute></ModuleRoute></ClientAdminRoute></ClientRoute>} />
